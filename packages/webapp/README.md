...
The direct-connect admin page keeps the entered `WEYSABI_ADMIN_API_KEY` in memory
...
backend that reads `WEYSABI_ADMIN_API_KEY` from a server-only environment variable
